# -*- coding: utf-8 -*-
#
# pytest-skipuntil documentation build configuration file, created by
...
project = 'pytest-skipuntil'
copyright = '2015, Pavel Bityukov'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-skipuntil Documentation',
     [author], 1)
]
